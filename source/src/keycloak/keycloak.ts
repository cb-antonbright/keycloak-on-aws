...
export class KeycloakVersion {
  ...
  /**
   * 
   * Keycloak version cb.15.0.2
   */
  public static readonly cbV15_0_2 = KeycloakVersion.of('cb.15.0.2');
...
//   private getImageUriFromMap(map: dockerImageMap, version: string, id: string): string {
// //  if (version.startsWith('cb.')) {
// //         console.log("reached here")
// //         return map['aws-cb']+=version.replace("cb.","")
// //  }
...
//       "aws": {
//         "uri": "jboss/keycloak:cb.15.0.2"
//       },
//       "aws-cn": {
//         "uri": "048912060910.dkr.ecr.cn-northwest-1.amazonaws.com.cn/dockerhub/jboss/keycloak:cb.15.0.2"
//       },
//       "aws-cb": {
//         "uri": "441603337042.dkr.ecr.us-east-1.amazonaws.com/cb-keycloak:cb.15.0.2"
//       }
//     }
//   },*/
//     let appendVersion = version.startsWith('cb.') ? version.replace("cb.", "") : version;
...
//     } else {
//       if (stack.region.startsWith('cn-')) {
//         return map['aws-cn']+=appendVersion;
//       } else {
//         return map.aws += appendVersion;
//       }
//     }
//   }
